...
//    }
    ...
    /** === 퀴즈 5건을 등록합니다. === */
    private void setup() {
        System.out.println("--- 등록 개시 ---");
        // 엔티티 생성
        Quiz quiz1 = new Quiz(null, "Spring은 프레임워크입니까?", true, "등록 담당");
        Quiz quiz2 = new Quiz(null, "자바는 객체지향 언어이다.", true, "등록 담당");
        Quiz quiz3 = new Quiz(null, "스프링 데이터는 데이터 엑세스에 관련된 기능을 제공한다.", true, "등록 담당");
        Quiz quiz4 = new Quiz(null, "프로그램이 많이 등록되어 있는 서버를 라이브러리라고 한다.", false, "등록 담당");
        Quiz quiz5 = new Quiz(null, "싱글 컨트롤러 패턴은 모든 요청을 하나의 컨트롤러에서 받는 것이다.", false, "등록 담당");
    ...
    private void updateQuiz(){
        ...
        // 변경할 엔티티를 생성
        Quiz quiz1 = new Quiz(1, "스프링은 프레임워크입니까?", true, "변경담당");
        // 변경 처리
